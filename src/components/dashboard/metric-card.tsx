...
export function MetricCard({ title, value, change, prefix, invert }: MetricCardProps) {
  const positiveColor = invert ? "#E41E3F" : "#31A24C";
  const negativeColor = invert ? "#31A24C" : "#E41E3F";
  return (
    <div className="bg-white dark:bg-[#111111] rounded-xl border border-[#E4E6EB] dark:border-[#2a2a2a] p-3 sm:p-5 hover:shadow-sm transition-shadow">
      ...
      {change !== null && (
        <div className="flex items-center gap-1.5 mt-2">
          {change > 0 ? (
            <div className="flex items-center gap-1" style={{ color: positiveColor }}>
            ...
            <div className="flex items-center gap-1" style={{ color: negativeColor }}>
